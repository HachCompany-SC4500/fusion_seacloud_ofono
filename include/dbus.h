...
#define OFONO_TELIT_TRACE_INTERFACE OFONO_SERVICE ".TelitTrace"
#define OFONO_TELIT_URC_INTERFACE OFONO_SERVICE ".TelitURC"
#define OFONO_TELIT_POWER_MANAGEMENT_INTERFACE OFONO_SERVICE ".TelitPowerManagement"
#define OFONO_TELIT_DATA_NETWORK_INTERFACE OFONO_SERVICE ".TelitDataNetwork"
#define OFONO_TELIT_HW_MANAGEMENT_INTERFACE OFONO_SERVICE ".TelitHWManagement"
#define OFONO_TELIT_ME_CONTROL_INTERFACE OFONO_SERVICE ".TelitMEControl"
#define OFONO_TELIT_PROVIDER_INTERFACE OFONO_SERVICE ".TelitProvider"
#define OFONO_TELIT_CUSTOM_INTERFACE OFONO_SERVICE ".TelitCustom"
